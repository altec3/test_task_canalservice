...
from config.settings import (VALUTE_CHAR_CODE, VALUTE_INFO_OPEN_TAG,
                             VALUTE_INFO_VALUE_OPEN_TAG, VALUTE_INFO_VALUE_CLOSE_TAG,
                             VALUTE_INFO_NOMINAL_OPEN_TAG, VALUTE_INFO_NOMINAL_CLOSE_TAG,)
